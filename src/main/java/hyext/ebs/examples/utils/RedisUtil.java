...
public class RedisUtil {
    ...
    private Jedis jedisSingleton;

    private RedisUtil() throws IOException {
        if (pool == null) {
            String ip = SysConfigUtil.getSysConfigUtil("application.yml").getProperty("redis.host");
            int port = Integer.parseInt(SysConfigUtil.getSysConfigUtil("application.yml").getProperty("redis.port"));
            String password = SysConfigUtil.getSysConfigUtil("application.yml").getProperty("redis.password");
            JedisPoolConfig jedisPoolConfig = new JedisPoolConfig();
            jedisPoolConfig.setMaxTotal(Integer.parseInt(SysConfigUtil.getSysConfigUtil("application.yml").getProperty("redis.maxTotal")));
            jedisPoolConfig.setMaxIdle(Integer.parseInt(SysConfigUtil.getSysConfigUtil("application.yml").getProperty("redis.maxIdle")));
        ...
        jedisSingleton = pool.getResource();
    }
    ...
    public static RedisUtil getRedisUtil() throws IOException {
        if(redisUtil == null){
